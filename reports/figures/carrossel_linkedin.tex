  ...
  \begin{minipage}{\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \node[fill=BgCard, draw=Border, rounded corners=3pt,
            text width=25mm, align=flush center, inner sep=3mm] (c1) at (0,0) {
        {\fontsize{19}{22}\selectfont\textcolor{AccOrange}{\textbf{US\$126}}}\\[1.5pt]
        {\fontsize{8}{10}\selectfont\textcolor{TxtPrimary}{\textbf{Brent}}}\\
        {\fontsize{6.5}{8}\selectfont\textcolor{TxtSub}{máx. em 4 anos}}
      };
      % ── Card 2: VIX ──
      \node[fill=BgCard, draw=Border, rounded corners=3pt,
            text width=25mm, align=flush center, inner sep=3mm,
            right=0.5mm of c1] (c2) {
        {\fontsize{19}{22}\selectfont\textcolor{AccRed}{\textbf{VIX 30}}}\\[1.5pt]
        {\fontsize{8}{10}\selectfont\textcolor{TxtPrimary}{\textbf{Risco Global}}}\\
        {\fontsize{6.5}{8}\selectfont\textcolor{TxtSub}{pânico nos mercados}}
      };
      % ── Card 3: USD/BRL ──
      \node[fill=BgCard, draw=Border, rounded corners=3pt,
            text width=25mm, align=flush center, inner sep=3mm,
            right=0.5mm of c2] (c3) {
        {\fontsize{19}{22}\selectfont\textcolor{AccBlue}{\textbf{R\$5,74}}}\\[1.5pt]
        {\fontsize{8}{10}\selectfont\textcolor{TxtPrimary}{\textbf{USD/BRL}}}\\
        {\fontsize{6.5}{8}\selectfont\textcolor{TxtSub}{fuga para safe haven}}
      };
    \end{tikzpicture}
...
\begin{frame}
  ...
  \begin{minipage}{\textwidth}
    ...
    {\color{Border}\rule{\textwidth}{0.5pt}}
  ...
  \begin{minipage}{\textwidth}
    ...
    \begin{tikzpicture}[node distance=2mm]
      ...
      \node[fill=BgCard, draw=Border, rounded corners=2.5pt,
            text width=85mm, inner xsep=4mm, inner ysep=2.5mm] (r1) {
      ...
      \node[fill=BgCard, draw=Border, rounded corners=2.5pt,
            text width=85mm, inner xsep=4mm, inner ysep=2.5mm,
            below=of r1] (r2) {
